			    ...
			    <div class="card">
			        ...
			        <div class="card-footer justify-content-between d-flex">
			            ...
			            <ul class="list-inline mb-0">
			                <li><a href="{{ route('vehicle.edit', $value->id) }}">Edit</a></li>
			                <li><a href="{{ route('flagged.edit', $value->id) }}" target="_blank">Flagged</a></li>
			                <li><a href="{{ route('sellerqa', $value->slug) }}" target="_blank">Seller Q&A</a></li>
			                <li>
