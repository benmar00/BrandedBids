    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">{{ $data == null ? 'Add' : 'Update ' }} Faq
                ...
                <div class="col-lg-12 col-12">
                    <div class="box">
                        ...
                        <form class="form" method="post"
                            action="{{ $data == null ? route('faq.store') : route('faq.update', $data->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group{{ $errors->has('faq_category_id') ? 'has-error' : '' }}">
                                            <label for="faq_category_id" class="control-label">{{ 'Faq Category' }}</label>
                                            <select name="faq_category_id" class="form-control" id="faq_category_id"
                                                name="faq_category_id">
                                                @foreach ($category as $item)
                                                    <option
                                                        {{ $data ? ($data->faq_category_id == $item->id ? 'selected' : '') : '' }}
                                        ...
                                        <div class="form-group{{ $errors->has('question') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control" name="question" type="text" id="question"
                                                value="{{ $data == null ? old('question') : $data->question }}" required>
