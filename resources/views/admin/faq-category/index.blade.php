...
@section('title', 'FaqCategory List')
@section('content')
<div class="container-full">
	<div class="content-header">
	    <div class="d-flex align-items-center">
	        <div class="mr-auto">
	            <h3 class="page-title">FaqCategory List</h3>
	            <div class="d-inline-block align-items-center">
	                <nav>
	                    <ol class="breadcrumb">
	                        ...
	                        <li class="breadcrumb-item active" aria-current="page">FaqCategory List</li>
	                    </ol>
	                </nav>
	            </div>
	        </div>
		...
		<div class="card">
		    <div class="card-header">
	    		<div class="col-md-6 pl-0">
	    			<h4 class="card-title">FaqCategory Lists</h4>
	    		</div>
	    		<div class="col-md-6">
	    			<form method="get" action="{{ route('faq-category.index') }}">
			    ...
			    <div class="card">
			        ...
			        <div class="card-footer justify-content-between d-flex">
			            ...
			            <ul class="list-inline mb-0">
			                <li><a href="{{ route('faq-category.edit', $value->id) }}">Edit</a></li>
			                <li>
			                	<form action="{{ route('faq-category.destroy', $value->id) }}" method="POST">
			                		@csrf
			                		@method('DELETE')
