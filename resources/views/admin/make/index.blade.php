...
<div class="container-full">
	<div class="content-header">
	    <div class="d-flex align-items-center">
	        <div class="mr-auto">
	            <h3 class="page-title">Make List</h3>
		...
		<div class="card">
		    <div class="card-header">
	    		<div class="col-md-6 pl-0">
	    			<h4 class="card-title">Make Lists</h4>
	    		</div>
	    		<div class="col-md-6">
			    ...
			    <div class="card">
			        ...
			        <div class="card-footer justify-content-between d-flex">
			            ...
			            <ul class="list-inline mb-0">
			                <li><a href="{{ route('make.edit', $value->id) }}">Edit</a></li>
			                <li>
			                	<form action="{{ route('make.destroy', $value->id) }}" method="POST">
			                		@csrf
			                		@method('DELETE')
