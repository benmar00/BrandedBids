                            ...
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="">Seller or Customer</label>
                                            <div class="flexradio">
                                                <input name="is_seller" id="customer" {{ $data->is_seller == 0 ? 'checked' : '' }} value="0" type="radio">
                                                <label for="customer">Customer</label>
                                                <input name="is_seller" {{ $data->is_seller == 1 ? 'checked' : '' }} id="seller" value="1" type="radio">
